...
c.prototype=b.prototype;a.M=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Al=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Hl;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.za}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
;function Md(a,b){this.i=a[y.Symbol.iterator]();this.j=b;this.l=0}
Md.prototype[Symbol.iterator]=function(){return this};
Md.prototype.next=function(){var a=this.i.next();return{value:a.done?void 0:this.j.call(void 0,a.value,this.l++),done:a.done}};
...
function he(a){if(!(a instanceof ce))return a;var b=!1;return{next:function(){for(var c;!b;)try{c=a.h();break}catch(d){if(d!==be)throw d;b=!0}return{value:c,done:b}}}}
function ee(a){this.j=a}
ee.prototype.K=function(){return new fe(this.j())};
ee.prototype[Symbol.iterator]=function(){return new ge(this.j())};
ee.prototype.i=function(){return new ge(this.j())};
...
function we(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ea&&f.listener==b&&f.capture==!!c&&f.ka==d)return e}return-1}
...
function Ie(a,b){if(a.ea)a=!0;else{b=new pe(b,this);var c=a.listener,d=a.ka||a.src;a.ha&&Ke(a);a=c.call(d,b)}return a}
...
function Oe(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ea&&g.capture==c){var h=g.listener,k=g.ka||g.src;g.ha&&xe(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
Ef.prototype.K=function(a){var b=this.i.K(!0),c=this,d=new ce;d.h=function(){for(var e=b.h();e.substr(0,c.h.length)!=c.h;)e=b.h();return a?e.substr(c.h.length):c.i.get(e)};
...
function Xh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.zl||F("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().yl:b=vd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
...
v(R,yi);function Ji(a){R.call(this,"MISSING_OBJECT_STORE",{hb:a},Ei.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Ji.prototype)}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",El:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
qj.prototype.open=function(){function a(){return H(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var z=h.options;for(var I=u(Object.keys(z.la)),E=I.next();!E.done;E=I.next()){E=E.value;var Q=z.la[E],V=void 0===Q.nb?Number.MAX_VALUE:Q.nb;if(k.h.version>=Q.ra&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(E)){z=E;break a}}z=void 0}l=z;if(void 0===l){p.B(5);break}if(h.j){p.B(6);break}h.j=!0;return w(p,
h.delete(),7);case 7:return wi(new R("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,hb:l})),p.return(a());case 6:throw new Ji(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.B(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,wb:b,upgrade:this.options.upgrade};return this.h=d=a()};var sj=new qj("YtIdbMeta",{la:{databases:{ra:1}},upgrade:function(a,b){b(1)&&aj(a,"databases",{keyPath:"actualName"})}});
...
v(T,Me);function hk(){if(!T.h){var a=B("yt.networkStatusManager.instance")||new T;A("yt.networkStatusManager.instance",a,void 0);T.h=a}return T.h}
m=T.prototype;m.L=function(){return this.j};
m.ib=function(a){this.l=!0;if(void 0===a?0:a)this.C||ik(this)};
...
T.prototype.sendNetworkCheckRequest=T.prototype.Y;T.prototype.listen=T.prototype.ca;T.prototype.enableErrorFlushing=T.prototype.Ta;T.prototype.getWindowStatus=T.prototype.wa;T.prototype.monitorNetworkStatusChange=T.prototype.ib;T.prototype.isNetworkAvailable=T.prototype.L;T.getInstance=hk;function jk(a){a=void 0===a?{}:a;Me.call(this);var b=this;this.l=this.A=0;this.j=hk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Ua);a.gb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.na?(this.na=a.na,c("ytnetworkstatus-online",function(){kk(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){kk(b,"publicytnetworkstatus-offline")})):
...
function kk(a,b){a.na?a.l?(lg(a.A),a.A=jg(function(){a.m!==b&&(Ne(a,b),a.m=b,a.l=P())},a.na-(P()-a.l))):(Ne(a,b),a.m=b,a.l=P()):Ne(a,b)}
;var lk=!1,mk,nk=0,ok=0,pk,qk=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:lk,Ia:mk,potentialEsfErrorCounter:ok,isIdbSupported:!!mk};A("ytNetworklessLoggingInitializationOptions",qk,void 0);
function rk(){H(this,function b(){return x(b,function(c){switch(c.h){case 1:return w(c,Bj(),2);case 2:mk=c.i;if(!mk||!zi()&&!O("nwl_init_require_datasync_id_killswitch")){c.B(0);break}lk=!0;qk.isNwlInitialized=lk;qk.Ia=mk;qk.isIdbSupported=!!mk;return w(c,Jj("LogsDatabaseV2"),4);case 4:if(!(.1>=Math.random())){c.B(5);break}return w(c,Vj(),6);case 6:return w(c,Zj(),5);case 5:sk();tk().L()&&uk();tk().ca("publicytnetworkstatus-online",uk);tk().ca("publicytnetworkstatus-offline",vk);if(!O("networkless_immediately_drop_sw_health_store")){c.B(8);
...
function tk(){pk||(pk=new jk({gb:!0,Ua:!0}));return pk}
...
Mk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Dl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Hk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.ma[l.name])for(e=u(c.ma[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
Sc:105350,Tc:131392,Vc:113533,Wc:93252,Xc:99357,Zc:94521,bd:114252,cd:113532,dd:94522,Yc:94583,ed:88E3,fd:93253,gd:93254,hd:94387,jd:94388,kd:93255,ld:97424,Uc:72502,md:110111,nd:76019,pd:117092,qd:117093,od:89431,rd:110466,sd:77240,td:60508,ud:73393,vd:113534,wd:92098,xd:131381,yd:84517,zd:83759,Ad:80357,Bd:86113,Cd:72598,Dd:72733,Ed:107349,Fd:124275,Gd:118203,Hd:133275,Id:133274,Jd:133272,Kd:133273,Ld:133276,Md:117431,Nd:133405,Od:117429,Pd:117430,Qd:117432,Rd:120080,Sd:117259,Td:121692,Ud:132972,
wi:75707,xi:83113,yi:101952,zi:101953,Bi:79610,Ci:125755,Di:24402,Ei:24400,Fi:32925,Gi:57173,Hi:122502,Ii:64423,Ji:64424,Ki:33986,Li:100828,Mi:129089,Ni:21409,Oi:11070,Pi:11074,Qi:17880,Ri:14001,Ti:30709,Ui:30707,Vi:30711,Wi:30710,Xi:30708,Si:26984,Yi:63648,Zi:63649,aj:51879,bj:111059,cj:5754,dj:20445,fj:130975,ej:130976,gj:110386,hj:113746,ij:66557,jj:17310,kj:28631,lj:21589,mj:68012,nj:60480,oj:31571,pj:76980,qj:41577,rj:45469,sj:38669,tj:13768,uj:13777,vj:62985,wj:4724,xj:59369,yj:43927,zj:43928,
Aj:12924,Bj:100355,Ej:56219,Fj:27669,Gj:10337,Dj:47896,Hj:122629,Ij:121258,Jj:107598,Kj:127991,Lj:96639,Mj:107536,Nj:130169,Oj:96661,Pj:96658,Qj:116646,Rj:121122,Sj:96660,Tj:127738,Uj:127083,Vj:104443,Wj:96659,Xj:106442,Yj:63667,Zj:63668,ak:63669,bk:130686,ck:78314,dk:55761,ek:127098,fk:96368,gk:67374,hk:48992,ik:49956,jk:31961,kk:26388,lk:23811,mk:5E4,nk:126250,pk:96370,qk:47355,rk:47356,sk:37935,tk:45521,uk:21760,vk:83769,wk:49977,xk:49974,yk:93497,zk:93498,Ak:34325,Bk:115803,Ck:123707,Dk:100081,
Ek:35309,Fk:68314,Gk:25602,Hk:100339,Ik:59018,Jk:18248,Kk:50625,Lk:9729,Mk:37168,Nk:37169,Ok:21667,Pk:16749,Qk:18635,Rk:39305,Sk:18046,Tk:53969,Uk:8213,Vk:93926,Wk:102852,Xk:110099,Yk:22678,Zk:69076,bl:100856,dl:17736,fl:3832,il:55759,jl:64031,kl:93044,ll:93045,ml:34388,nl:17657,ol:17655,pl:39579,ql:39578,rl:77448,sl:8196,ul:11357,vl:69877,wl:8197,xl:82039};function cl(){var a=kb(dl),b;return cf(new We(function(c,d){a.onSuccess=function(e){Ig(e)?c(new el(e)):d(new fl("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var ul,vl=y.ytLoggingDocDocumentNonce_;vl||(vl=tl(),Ra("ytLoggingDocDocumentNonce_",vl));ul=vl;var wl={Ee:0,kc:1,tc:2,Jh:3,Ge:4,al:5,Ai:6,Cj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function xl(a){this.h=a}
...
tn.prototype.D=function(){window.removeEventListener("message",this.A);L.prototype.D.call(this)};function un(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new tn(!!F("WIDGET_ID_ENFORCE")),b=this.mb.bind(this);a.m=b;a.o=null;this.h.channel="widget";if(a=F("WIDGET_ID"))this.h.sessionId=a}
...
;function Pn(a,b,c,d){L.call(this);var e=this;this.G=b;this.webPlayerContextConfig=d;this.oa=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.O=this.fa=this.elementId=this.qa=this.config=null;this.N=!1;this.l=this.A=null;this.ga={};this.Pa=["onReady"];this.lastError=null;this.Da=NaN;this.C={};this.Qa=new In(this);this.aa=0;this.j=this.o=a;Xd(this,Qa(Vd,this.J));Qn(this);Rn(this);Xd(this,Qa(Vd,this.Qa));c?this.aa=dg(function(){e.loadNewVideoConfig(c)},0):d&&(Sn(this),Tn(this))}
